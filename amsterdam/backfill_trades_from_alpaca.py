    ...
    for order in orders:
        ...
        if side == "buy":
            ...
            entry = {
                ...
                "qty": int(qty),
                "price": price,
                "features": {"strategy": "AlpacaBroker", "source": "alpaca_backfill"},
            }

            open_positions[symbol].append({"entry": entry, "entry_price": price, "qty": qty, "entry_time": filled_at})
            ...
            while remaining_qty > 0 and open_positions[symbol]:
                ...
                completed_trades.append({"entry": position["entry"], "exit": exit_trade})
...
def main():
    ...
    print("2. If correct, replace meta_trades_live.jsonl:")
