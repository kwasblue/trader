...
class ManualOrderDialog(QtWidgets.QDialog):
    def __init__(self, parent=None, symbols: list[str] | None = None):
        ...
        self.symbol.addItems(self._symbols)
        self.side = QtWidgets.QComboBox()
        self.side.addItems(["BUY", "SELL", "SHORT", "COVER"])
        self.qty = QtWidgets.QSpinBox()
        self.qty.setRange(1, 1_000_000)
        self.qty.setValue(100)
        self.ord_type = QtWidgets.QComboBox()
        self.ord_type.addItems(["MARKET", "LIMIT"])
        ...
        self.tif.addItems(["DAY", "IOC", "FOK", "GTC"])
        self.route = QtWidgets.QComboBox()
        self.route.addItems(["Auto", "Alpaca", "Schwab", "Sim"])  # NEW: Route selector
        self.reduce_only = QtWidgets.QCheckBox("Reduce-only")
        self.sl = QtWidgets.QDoubleSpinBox()
        self.sl.setRange(0.0, 1_000_000.0)
        self.sl.setDecimals(4)
        self.sl.setValue(0.0)
        self.tp = QtWidgets.QDoubleSpinBox()
        self.tp.setRange(0.0, 1_000_000.0)
        self.tp.setDecimals(4)
