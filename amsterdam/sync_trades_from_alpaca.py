...
# Setup logging
logger = Logger(log_file="alpaca_sync.log", logger_name="AlpacaSync", log_dir="/home/kwasi/amsterdam/logs").get_logger()
...
def fetch_recent_alpaca_orders(since_hours=24):
    ...
    try:
        ...
        recent_filled = [
            o for o in orders if str(o.status.value).lower() == "filled" and o.filled_at and o.filled_at > cutoff
        ]
