...
def create_mock_backtester(sharpe=1.5, total_return=0.10, sortino=1.8, max_dd=-0.15):
    ...
    mock_bt = MagicMock()
    mock_portfolio = pd.DataFrame({"Portfolio_Value": [10000, 10100, 10200, 10300, 10400]})
...
class TestOptimizationResult:
    ...
    def test_dataclass_creation(self):
        ...
        result = OptimizationResult(
            best_params={"sma_window": 20}, best_metric=1.5, all_results=[], metric_name="sharpe_ratio"
        )
...
class TestGridSearch:
    ...
    def test_grid_search_basic(self, sample_data):
        ...
        param_grid = {"sma_window": [10, 20], "ema_window": [5, 10]}
    ...
    def test_grid_search_different_metrics(self, sample_data):
        ...
        with patch(BACKTESTER_PATCH) as MockBT:
            ...
            result_return = grid_search(
                sample_data, strategy_name="SMA", param_grid=param_grid, metric="total_return", verbose=False
            )
            assert result_return.metric_name == "total_return"

            # Test with max_drawdown
            result_dd = grid_search(
                sample_data, strategy_name="SMA", param_grid=param_grid, metric="max_drawdown", verbose=False
            )
    ...
    def test_grid_search_best_is_maximum(self, sample_data):
        ...
        with patch(BACKTESTER_PATCH) as MockBT:
            ...
            result = grid_search(
                sample_data, strategy_name="SMA", param_grid=param_grid, metric="sharpe_ratio", verbose=False
            )
    ...
    def test_grid_search_no_valid_results_raises(self, sample_data):
        ...
        with patch(BACKTESTER_PATCH) as MockBT:
            ...
            with pytest.raises(ValueError, match="No valid results"):
                grid_search(sample_data, strategy_name="SMA", param_grid=param_grid, verbose=False)
...
class TestEdgeCases:
    ...
    def test_single_param_combination(self, sample_data):
        ...
        with patch(BACKTESTER_PATCH) as MockBT:
            ...
            result = grid_search(sample_data, strategy_name="SMA", param_grid={"sma_window": [20]}, verbose=False)
    ...
    def test_grid_search_with_transaction_cost(self, sample_data):
        ...
        with patch(BACKTESTER_PATCH) as MockBT:
            ...
            result_high_cost = grid_search(
                sample_data, strategy_name="SMA", param_grid={"sma_window": [20]}, transaction_cost=0.01, verbose=False
            )
