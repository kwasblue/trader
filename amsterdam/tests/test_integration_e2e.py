...
def test_end_to_end_bar_flow():
    ...
    def on_bar(bar: Bar):
        ...
        print(
            f"  ✓ Received {bar.symbol} bar @ {bar.timestamp.strftime('%H:%M')} "
...
def test_regime_change_timeframe_switch():
    ...
    test_config = {
        "AAPL": {
            "low_volatility": {"strategy": "meanreversion", "timeframe": "5min"},
            "normal": {"strategy": "rsi", "timeframe": "15min"},
            "high_volatility": {"strategy": "rsi", "timeframe": "30min"},
            "default": {"strategy": "rsi", "timeframe": "5min"},
            "use_hybrid": False,
        }
    }
    ...
    try:
        ...
        # Check stats
        stats = aggregator.get_stats()
        assert stats["timeframe_changes"] == 1, f"Expected 1 timeframe change, got {stats['timeframe_changes']}"

        print("  ✅ Regime Change: OK (timeframe switches recorded)")
...
def test_multiple_symbols_different_timeframes():
    ...
    test_config = {
        "AAPL": {"normal": {"strategy": "rsi", "timeframe": "5min"}},
        "TSLA": {"normal": {"strategy": "momentum", "timeframe": "15min"}},
        "MSFT": {"normal": {"strategy": "sma", "timeframe": "30min"}},
    }
