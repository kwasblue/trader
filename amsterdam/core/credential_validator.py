...
class CredentialValidator:
    ...
    async def validate_all(self) -> Dict[str, ValidationResult]:
        ...
        self.logger.info(f"Validation complete. Schwab: {'OK' if schwab_ok else 'FAIL'}, Alpaca: {'OK' if alpaca_ok else 'FAIL'}")
    ...
    def _find_schwab_token_file(self) -> Optional[Path]:
    ...
    def _check_refresh_token(self, token_data: dict) -> Tuple[CredentialStatus, Optional[int]]:
        """
